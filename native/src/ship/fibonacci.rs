...
//!
//! Generates floor planes and 3m walls for each room in the ship layout.
...
pub fn generate_homestead() -> HomesteadMeshes {
    ...
    for room in &rooms {
        ...
        // Visible from below (CCW when looking up)
        all_wall_indices.extend([
            ceil_base, ceil_base + 2, ceil_base + 1,
            ceil_base, ceil_base + 3, ceil_base + 2,
        ]);
    }

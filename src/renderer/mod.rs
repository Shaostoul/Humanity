...
impl Renderer {
    ...
    pub fn render_scene(
...

        {
            ...
            self.draw_opaque_objects(&mut render_pass, objects, "scene opaque pass");
        }
    ...
    pub fn render_celestial_onto(
...

        {
            ...
            // shells live in `transparent`, never here.
            self.draw_opaque_objects(&mut render_pass, objects, "celestial classic loop");

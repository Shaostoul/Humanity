# Priorities archive: 2026-05-26 to 2026-08-12

Retired from `docs/PRIORITIES.md` on 2026-09-20 at v0.1326.1.

This was the file's "Active focus" section: about three thousand lines of dated
blocks reaching back to the web chat rebuild in May 2026. Everything in it is
history. It is kept verbatim for the same reason as its sibling archive
(`priorities-archive-2026-08-to-09.md`): the blocks record what was measured and
what was rejected, and a backlog that throws that away makes the next session
re-litigate settled ground.

Anything still open at archival time was carried forward into the new
`docs/PRIORITIES.md`. The final section below holds the TIER 0 and TIER 1 entries
that were retired at the same time, all of them DONE.
...
## The retired TIER 0, TIER 1 and TIER 2 entries

These are the TIER 0, TIER 1 and TIER 2 lists exactly as they stood. Every TIER 0
entry was DONE, which is the defect that makes a backlog stop routing work: a
reader had to walk nine completed items before reaching anything actionable. The
security-audit entry (item 0) is kept in full because its refuted findings are
still referenced and must not be re-flagged; its two genuinely open residuals were
carried forward into TIER 1 of the new file. The TIER 2 entries that are still
open were carried forward in condensed form, with their design docs as the
pointer; the shipped sub-history stays here.

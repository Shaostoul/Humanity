# Header Navigation with Dropdowns (Finalization Draft, archived 2026-06-30)

> **Superseded, never adopted.** Written 2026-03-06 during an early nav-IA exploration.
> The actual shipped nav is a flat top-level `GuiPage` enum (52 pages, see `docs/PAGES.md`
> and `src/gui/mod.rs`) with no H/Private/Public/Ops dropdown structure. Kept for
> historical record of the exploration; do not treat as current or "final."

# Full-PQ Cutover: Execution Runbook (COMPLETE, archived 2026-06-30)

> **All increments including Inc6 (the attended fresh-slate wipe) are done and verified.**
> Per `CLAUDE.md`'s Cryptography section: the post-quantum cutover is shipped AND
> activated (verified 2026-05-20). Chat identity = Dilithium3/ML-DSA-65, DM E2EE = pure
> Kyber768 dual-seal, vaults PBKDF2 600k both clients. Moved here from `docs/design/`
> since this runbook's job is finished; kept for the historical execution record. For
> the current, canonical crypto inventory, always read `CLAUDE.md`'s Cryptography

# Humanity Full-Replacement Blueprint (Open Draft, archived 2026-06-30)

> **Superseded.** A generic March 2026 aspirational backlog (Tracks A-D, "Immediate
> Next 10 Ship Items"). Most listed items have since shipped in different form (e.g.
> Studio Mode is real, `src/gui/pages/studio.rs`) or were never prioritized; the list
> itself was never maintained. For current priorities see `docs/PRIORITIES.md` and
> `docs/ROADMAP.md`. Kept for historical record.

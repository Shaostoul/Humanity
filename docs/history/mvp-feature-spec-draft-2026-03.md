# Humanity MVP Feature Spec (Draft v0.1, archived 2026-06-30)

> **Superseded.** An early (2026-03) speculative MVP scope, written before the actual
> product shipped. All the "in-scope" items here (identity, E2EE messaging, presence,
> block/mute/report, cross-surface continuity) and most of the "out of scope" items
> (marketplace, federation) have since shipped and gone well beyond this spec, see
> `docs/FEATURES.md` and `docs/STATUS.md` for what's actually built. Kept for historical
> record of the early planning phase.

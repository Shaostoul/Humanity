...
> **Archived 2026-06-30.** Dated tactical snapshot from v0.91.x, superseded by the live
> `docs/PRIORITIES.md` (tactical) and `docs/ROADMAP.md` (strategic). Moved from
> `docs/design/` to `docs/history/` as a point-in-time record; do not treat as current.

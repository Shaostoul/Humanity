...
> **Archived 2026-06-30. SPECULATIVE PROPOSAL, NEVER ADOPTED.** A one-off idea to turn the
> chat relay into a Bittensor TAO-mining subnet ($285k-$410k proposed startup cost). No
> Bittensor/TAO/libp2p code exists anywhere in this repo; the real identity/crypto stack is
> Dilithium3/Kyber768 (see the Cryptography section of `CLAUDE.md`), unrelated to this
> proposal. Moved from `docs/design/` to `docs/history/` as a rejected idea.

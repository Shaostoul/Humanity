...
This document summarizes the fundamental rights and responsibilities
that apply to all humans operating under the Humanity Framework.

Rights define what must not be violated.
Responsibilities define what must not be ignored.
...
Claiming security or privacy that does not exist
constitutes harm.
...
Rights without responsibility decay into exploitation.
Responsibilities without rights become oppression.
...
Human rights are not permissions.
Human responsibilities are not optional.

They are the minimum conditions
for living together without domination or fear.

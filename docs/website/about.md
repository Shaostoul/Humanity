...
- **Shelter**, build where you are
- **Health**, understand your body and environment
- **Education**, learn by doing
- **Community**, cooperate to thrive
...
- E2E encrypted DMs, post-quantum Kyber768 / ML-KEM-768 to BLAKE3-KDF to AES-256-GCM, server never sees plaintext
...
*(Cryptography details summarized here; the canonical, always-current inventory of algorithms lives in the "Cryptography" section of `CLAUDE.md`.)*
...
*Everything here is public domain. Use it, share it, build on it.*

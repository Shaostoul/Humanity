...
This is the parent entry for major documentation areas.

## Core
- [README](../README.md)
- [OPERATING_CONTRACT](../OPERATING_CONTRACT.md)
- [AGENTS](../AGENTS.md)
- [TOOLS](../TOOLS.md)
...
## Module Specs (authoritative in design/)
...
- [module-carpentry](../design/modules/module-carpentry.md)
- [module-electrical-basics](../design/modules/module-electrical-basics.md)
- [module-plumbing-basics](../design/modules/module-plumbing-basics.md)
- [module-health-first-aid](../design/modules/module-health-first-aid.md)
...
- [Offline Playable No-Combat Milestone](../design/game/offline_playable_no_combat_milestone.md)
...
- [Operations Runbook](../knowledge/OPERATIONS_RUNBOOK.md)

## Accord
- [Accord README](../accord/README.md)
- [Humanity Accord](../accord/humanity_accord.md)

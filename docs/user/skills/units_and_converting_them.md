...
[Insulation and Heat Loss](insulation_and_heat_loss.md). It is 68 F
...
grain, as [Working with Wood](../making/working_with_wood.md) explains.
...
- [Insulation and Heat Loss](insulation_and_heat_loss.md), where the
  temperature interval trap in this guide does real damage if you get it
  wrong.
- [Working with Wood](../making/working_with_wood.md), for why a board

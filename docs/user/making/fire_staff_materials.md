...
Where a material number matters, it comes from published alloy and fibre
data rather than from a shop selling the part. That distinction matters
here more than usual, because most fire-spinning technical writing is
published by retailers.
...
worst heat behaviour. It is roughly twice the tensile strength of 6061,
which lets you run a thinner wall, but it starts to melt lower: solidus
near 477 C against 582 C for 6061. Pick 7075 for stiffness at low
weight, 6061 for budget and forgiveness.

**"The wick is Kevlar."** It is almost always a blend. Standard wick
tape is aramid (Kevlar plus Nomex) with fibreglass. Thickness matters
more than brand.
...
| Material | Starts to fail | How it fails |
|---|---|---|
| Epoxy matrix (carbon fibre binder) | 120 C | Softens |
| Aluminium temper, 6061 and 7075-T6 | 180 C sustained | Loses strength |
| Silicone tape and tubing | 260 C | Degrades |
| Nomex (in the wick blend) | 370 C | Degrades |
| Kevlar and other para-aramids | 425 to 480 C | Chars, never melts |
| 7075-T6 aluminium | 477 C | Solidus, starts to melt |
| Technora | 500 C | Degrades |
| 6061-T6 aluminium | 582 C | Solidus, starts to melt |
| E-glass fibreglass | 840 C | Softens |
| Stainless 304 | 1400 C | Melts |
| Titanium | 1668 C | Melts |

A flame does not have one temperature. In a candle-type diffusion flame
the inner region sits near 800 C, the blue outer core reaches about
1400 C, and soot measurements find 2000 to 2200 K (1730 to 1930 C) in
the thin reaction sheet. Every row above falls inside that range,
including titanium's melting point, which is why no material here is
genuinely immune.
...
Peak flame temperature is very nearly the same across liquid
hydrocarbons. Kerosene's adiabatic flame temperature in air is 2093 C;
gasoline and naphtha sit slightly higher, near 2100 to 2140 C. So the
widespread belief that camp fuel burns colder than kerosene is not a
claim about temperature, and on paper camp fuel is marginally the hotter
fuel.

What genuinely differs is **radiant heat and duration**. Kerosene has a
lower hydrogen-to-carbon ratio and more aromatics, so it soots heavily,
and soot particles are what make a flame radiate. It throws far more
radiant heat at your skin and your prop, and does so for 5 to 7 minutes
against camp fuel's 3 to 4. Camp fuel burns cleaner and bluer, radiates
less, and its volatility actively cools the wick as it evaporates.

The counterintuitive part: because a sooty flame radiates away more of
its own energy, kerosene's gas temperature can be slightly lower than
camp fuel's while feeling considerably hotter. Dimmer, longer, and
hotter-feeling all come from the same cause.
...
from the wick to your hands.

| Material | Cond. | Strengths | Weaknesses |
|---|---|---|---|
| **6061-T6 aluminium** | 167 | Cheap, stocked everywhere, bends instead of shattering, best heat spreading of the practical options | Half the strength of 7075, so a thicker wall and the heaviest metal build; flexy below 19 mm |
| **7075-T6 aluminium** | 130 | About twice the tensile strength of 6061 and 1.5x the shear, so thin walls; the market default for quality staffs | Solidus 477 C, the lowest shaft metal here; poor in heat-affected zones; hard to source in thin wall |
| **Carbon fibre** | 0.5 to 50 | Stiffest option, no flex, moves mass to the ends, survives impacts that would bend metal | Epoxy softens near 120 C so it *requires* aluminium sleeves; fails by shattering; never for anything you put in your mouth |
| **Titanium** | 6.7 to 21.9 | The only material that actually solves heat reaching your hands, roughly 25x less conductive than 6061 in alloy form; melts above the flame | Expensive, poor thin-wall availability, denser than aluminium, effectively absent from the market |
| **Stainless steel** | 14.4 | Melts near 1400 C, no temper to lose, corrosion proof, cheap next to titanium | About 3x the density of aluminium; a full-length stainless staff swings badly |
| **Mild steel** | 50 | Cheapest metal, indestructible, tolerates heat far better than aluminium | Heavy, rusts, unpleasant for fast spinning |
| **Hardwood dowel** | 0.15 | Almost no heat conduction so the grip stays cool; under five dollars; extra mass slows rotation, which genuinely helps a beginner; ash and hickory last decades | It is fuel; needs metal flashing at the ends; heaviest option; splits |
| **Bamboo** | 0.15 | Very light for its stiffness, traditional, cool to hold, often free | Once cracked it is finished; inconsistent walls; still combustible |
| **Fibreglass** | 0.3 | More impact tolerant than carbon fibre, cheaper, low conductivity | Same resin problem, so it still needs a sleeve; degrades under sustained heat; rarely sold for props |
...
coating, which gives off zinc oxide fume when heated and causes metal
fume fever. The wick zone is exactly where you do not want zinc. Buy
...
| **Technora** | Copolymer aramid, rope only | Leashes, not wicks. Best heat threshold at 500 C, but **poor fuel absorption**, which is disqualifying |
...
Aramid does not melt, it chars. Kevlar holds roughly 425 to 480 C short
term but loses about half its strength after 70 hours at 260 C, which is
the real ageing mechanism on a well-used prop.
...
over grass rather than pavement measurably extends wick life.
...
Buy 1/4 inch. For width, 3 to 5 inches is the normal staff range; wider
means more fuel, bigger flame, longer burn, and more end weight.
...
much: behaviour when wet, whether fuel attacks it, and heat.
...
| **Silicone self-fusing tape** | Slides in hand | 260 C, self-bonding, forgiving, comfortable | Less outright grip than tubing | Yes, and required nearby |
...
| **Natural foam rubber** | Very grippy | Among the grippiest available | Breaks down in 4 to 6 months; degrades under heat and UV | Avoid |
...
silicone self-fusing tape at about 260 C. The real answer is geometric:
the grip belongs at the centre of the staff where flame never reaches,
with silicone tape between grip and wick as the sacrificial barrier.

**The fuel problem nobody mentions.** Grip choice is partly a
solvent-compatibility question. Naphtha and lamp oil dissolve the
adhesives in cloth and sports tapes, so a taped grip goes gummy, traps
fuel, and becomes a wick in the wrong place. Silicone and industrial
rubber have no adhesive to attack and shed fuel instead of absorbing it.
That is the strongest argument for silicone on a fire prop, ahead of the
heat rating.
...
Do not use aluminium fasteners in the wick zone. They lose strength at
exactly the temperatures the collar reaches. Steel, stainless or brass
only.

## Fuel

Flash point is the number to read: the temperature at which a liquid
gives off enough vapour to ignite. Flame temperature is not a useful
...
- **A fire blanket.** Duvetyne, a heavy fire-retardant cotton, is the
  community standard; a wet towel is the acceptable substitute. Note the
  failure mode: a blanket soaked in fuel will itself catch, so keep it
  dry and let it air between uses.
- **Natural fibre clothing.** Cotton and wool resist ignition and do not
  melt. Synthetics ignite more readily and melt onto skin. Aim for 100
  percent natural fibre, 95 percent at minimum. No synthetic layer
  against the skin. Nothing dangly, whatever the fibre.
...
When all five are true you own a sound staff and you understand why each
...
- https://bonoboflow.com/what-is-the-best-staff-grip/
- https://bonoboflow.com/flat-wick-vs-knotted-wick-fire-props/
- https://fireandflow.co.nz/blogs/resources/the-wonderful-world-of-wicks
- https://flowartsinstitute.com/staff-maintenance/
- https://flowartsinstitute.com/fuel-science/
- https://firemecca.com/products/k1-tape-wick
- https://drexfactor.com/index.php?q=weirdscience%2F2016%2F03%2F27%2Fdancing_fire
...
- https://sendcutsend.com/blog/aluminum-alloy-comparison/
- https://hontitan.com/titanium-thermal-conductivity/
- https://zenodo.org/records/7236629
- https://hypertextbook.com/facts/1999/JaneFishler.shtml
- https://www.sciencedirect.com/science/article/abs/pii/S0894177716303053

  ...
  (function initMapSystem() {
   ...
   async function mapLoadData() {
    ...
    const [citiesRes, coastRes, starsRes, constsRes, mwRes] = await Promise.all([
     fetch('/game/data/cities.json'),
     fetch('/game/data/coastlines.json'),
     fetch('/game/data/stars-catalog.json'),
     fetch('/game/data/constellations.json'),
     fetch('/game/data/milky-way.json')
    ]);

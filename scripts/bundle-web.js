...
// A sign on the door. This tree is a byte-for-byte copy of web/, so a repo-wide
// grep hits it and an agent (or a person) edits the copy and wonders why nothing
// changed. It has cost at least two sessions real time that way. The note is
// written by the generator rather than committed by hand so it survives every
// regeneration, and it is excluded from the manifest below so it never counts
// as a bundled asset.
const readme = `# app/web is GENERATED. Do not edit anything here.

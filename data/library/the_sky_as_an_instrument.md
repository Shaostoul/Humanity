...
what day it is.
[The Growing Calendar](/library#the-growing-calendar) is what you do with the
answer.
...
dangerous. [Reading the Tide](/library#reading-the-tide) has the actual
...
- [Reading the Tide](/library#reading-the-tide), for what the moon's phase
...
- [The Growing Calendar](/library#the-growing-calendar), for what knowing the
  date is actually for here.
- [Units and Converting Them](/library#units-and-converting-them), for angles,

...
[Where Water Comes From](/library#where-water-comes-from) is the other half. It
...
[Your Soil, Specifically](/library#your-soil-specifically) teaches you to read.
...
[Silverdale gazetteer](/library#silverdale-wa) uses. So:
...
[Your Soil, Specifically](/library#your-soil-specifically) covers how to read
...
[Silverdale gazetteer](/library#silverdale-wa) covers in full and which
...
[Collecting Rainwater](/library#collecting-rainwater) covers.
...
- `data/locales/silverdale_wa/soil.json`, for the hydrologic soil groups,
  ...
  WA778.
- [Where Water Comes From](/library#where-water-comes-from), the companion guide
  on sources and their risks, and the origin of the habit of looking
  upstream.
- [Your Soil, Specifically](/library#your-soil-specifically), for how to look up
  a soil survey, what a restrictive layer is, and how to read a Very
  limited rating and the reason printed next to it.
- [Where You Are: Silverdale, Washington](/library#silverdale-wa), the
  ...
  classification.
- [Collecting Rainwater](/library#collecting-rainwater), for storing what you
